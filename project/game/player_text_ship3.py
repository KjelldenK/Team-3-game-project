...
class Player_Test_Ship3(Ship):
    # this is the testing player ship this is one of many ships the will be in the game
    def __init__(self):
        super().__init__("project\images\Player ships\playerShip2_green.png")
    ...
    def on_update(self, delta_time: 1 / 60):
        ...
        if self.shooting == True:
            if self.time_since_last_firing > self._attack_speed:
                self.bullet = arcade.Sprite("project\images\Lasers\laserGreen02.png", scale= 0.5)
